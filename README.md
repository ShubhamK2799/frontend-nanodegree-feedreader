...
This project is a part of Udacity Nanodegree Program. In this project we were given a web-based application that reads RSS feeds. It uses [Jasmine](http://jasmine.github.io/)  libraries to test various RSS feeds properties.
...
* Good tests gives us the ability to quickly analyze whether new code breaks an existing feature within your codebase, without having to manually test all of the functionality.
